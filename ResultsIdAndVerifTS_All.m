function TSResults = ResultsIdAndVerifTS_All(Distortion,Database,Thresholds)
%RESULTSIDANDVERIFTS_ALL Tests the TST LWIR face recognition algorithm
% without NSS features added, on several threshold values.
...
[idTPRates, ~, verifRates, ~] = idAndVerifResultsNoClass(TestFolder,Database,Thresholds);
disp('Calculating impostor scores...')
[~, idFalseAlarmRates, ~, veFalseAlarmRates] = idAndVerifResultsNoClass(TestNFolder,Database,Thresholds);
